module.exports = {
  ...
  hidden: [
    ...
    },
    {
      id: 'hidden-3',
      hidden: true,
      input: { target: 'class Base { constructor() { this.x = 1; } }', args: [] },
      expected: true
    },
    {
      id: 'hidden-4',
      hidden: true,
      input: { target: 'function A() {} function B() {} function C() {}', args: [] },
      expected: true
    },
    {
      id: 'hidden-5',
      hidden: true,
      input: { target: 'class GrandParent {} class Parent extends GrandParent {}', args: [] },
      expected: true
    }
  ]
}
